...
def plot_2D(y_pred, y_true, hyp_params, epoch, save_path, loss_comps, val_loss, pretrain):
    enc = y_pred[0]
    enc_dec = y_pred[1]
...
def plot_3d(y_pred, y_true, hyp_params, epoch, save_path, loss_comps, val_loss, pretrain):
    enc = y_pred[0]
    enc_dec = y_pred[1]
    enc_adv_dec = y_pred[2]
    enc_adv = y_pred[3]
